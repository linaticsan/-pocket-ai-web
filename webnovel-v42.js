...
const SOURCES=[
 {id:'wuxiaworld',name:'Wuxiaworld',icon:'⚔️',url:'https://www.wuxiaworld.com/',note:'Licensed translations',embed:false,reason:'This publisher does not permit third-party framing of its platform.'},
 {id:'novelnow',name:'NovelNow',icon:'📖',url:'https://www.novelnow.com/',note:'Web novels',embed:'try'},
 {id:'meganovel',name:'MegaNovel',icon:'✨',url:'https://www.meganovel.com/',note:'Free & premium novels',embed:false,reason:'Pocket AI does not mirror or bypass this publisher’s reader or access controls.'},
 {id:'tapas',name:'Tapas',icon:'🎨',url:'https://tapas.io/',note:'Comics & novels',embed:'try'},
 {id:'royalroad',name:'Royal Road',icon:'🏰',url:'https://www.royalroad.com/',note:'Author-published fiction',embed:'try'},
 {id:'scribblehub',name:'Scribble Hub',icon:'✍️',url:'https://www.scribblehub.com/',note:'Author-published fiction',embed:'try'}
];
...
function sourceCard(s){return '<article class="wn46-source"><span>'+s.icon+'</span><div><strong>'+esc(s.name)+'</strong><small>'+esc(s.note)+'</small></div><button data-wn46-source="'+s.id+'">'+(s.embed===false?'Official':'Reader')+'</button></article>'}
