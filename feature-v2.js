...
const mobile30=document.createElement('link');mobile30.rel='stylesheet';mobile30.href='./mobile-v30.css?v=20260919-2';document.head.appendChild(mobile30);
...
import('./api-hub.js?v=20260919-1').then(()=>import('./v3.js?v=20260919-smartapi2')).then(()=>import('./v3-guard.js?v=20260918-safe1')).then(()=>import('./coding-v1.js?v=20260918-1')).catch(err=>console.error('Pocket AI module failed to load',err));
