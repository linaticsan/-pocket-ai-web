...
const v3style=document.createElement('link');v3style.rel='stylesheet';v3style.href='./v3.css?v=20260920-v52';document.head.appendChild(v3style);
const v3hotfix=document.createElement('link');v3hotfix.rel='stylesheet';v3hotfix.href='./v3-hotfix.css?v=20260920-v52';document.head.appendChild(v3hotfix);
...
const mobile30=document.createElement('link');mobile30.rel='stylesheet';mobile30.href='./mobile-v30.css?v=20260920-v52';document.head.appendChild(mobile30);const lib33=document.createElement('link');lib33.rel='stylesheet';lib33.href='./library-v33.css?v=20260920-v53';document.head.appendChild(lib33);const lib34=document.createElement('link');lib34.rel='stylesheet';lib34.href='./library-online-v34.css?v=20260920-v52';document.head.appendChild(lib34);const wn42=document.createElement('link');wn42.rel='stylesheet';wn42.href='./webnovel-v42.css?v=20260920-v52';document.head.appendChild(wn42);const files31=document.createElement('link');files31.rel='stylesheet';files31.href='./files-v31.css?v=20260920-v52';document.head.appendChild(files31);const motion32=document.createElement('link');motion32.rel='stylesheet';motion32.href='./motion-v32.css?v=20260919-1';document.head.appendChild(motion32);const ui47=document.createElement('link');ui47.rel='stylesheet';ui47.href='./mobile-ui-fix-v47.css?v=20260920-v57';document.head.appendChild(ui47);const layout56=document.createElement('link');layout56.rel='stylesheet';layout56.href='./layout-v56.css?v=20260920-v57';document.head.appendChild(layout56);const soft55=document.createElement('link');soft55.rel='stylesheet';soft55.href='./soft-ui-v55.css?v=20260920-v57';document.head.appendChild(soft55);const ref57=document.createElement('link');ref57.rel='stylesheet';ref57.href='./reference-ui-v57.css?v=20260920-v58';document.head.appendChild(ref57);const ref58=document.createElement('link');ref58.rel='stylesheet';ref58.href='./reference-ui-v58.css?v=20260920-v58';document.head.appendChild(ref58);
...
(async()=>{
 ...
 await load('./v3.js?v=20260920-v58');
 await load('./v3-guard.js?v=20260920-v56');
 await load('./coding-v1.js?v=20260920-v56');
 await load('./files-v32.js?v=20260920-v58');
 await load('./library-v33.js?v=20260920-v58');
 await load('./library-online-v34.js?v=20260920-v56');
 await load('./webnovel-v42.js?v=20260920-v56');
 await load('./home-v43.js?v=20260920-v58');
 await load('./ui-v55.js?v=20260920-v58');
 await load('./repair-v56.js?v=20260920-v58');
 await load('./reference-ui-v57.js?v=20260920-v58');
 await load('./reference-ui-v58.js?v=20260920-v58');
})();

/* V52 legacy-library guard */
setTimeout(async()=>{
  const lib=document.getElementById('library');
  const legacy=lib && (/Your books become AI context/i.test(lib.textContent||'') || document.getElementById('libFileDesk') || document.getElementById('libSelectAll'));
  if(legacy){
    try{
      lib.remove();
      const mod=await import('./library-v33.js?v=20260920-v58');
      setTimeout(()=>window.PocketLibrary?.render?.(),50);
    }catch(err){console.error('Library V52 repair failed',err)}
  }
},500);
