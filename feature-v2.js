...
import('./api-hub.js?v=20260919-1').then(()=>import('./v3.js?v=20260919-smartapi3')).then(()=>import('./v3-guard.js?v=20260918-safe1')).then(()=>import('./coding-v1.js?v=20260918-1')).then(()=>import('./files-v32.js?v=20260919-1')).catch(err=>console.error('Pocket AI module failed to load',err));
