...
// Tab changes must land at the top immediately.
...
// Pocket AI V3: loaded last so it can progressively enhance the stable V2 tools without replacing their working foundations.
const v3style=document.createElement('link');v3style.rel='stylesheet';v3style.href='./v3.css?v=20260916-1';document.head.appendChild(v3style);
import('./v3.js?v=20260916-1').catch(err=>console.error('Pocket AI V3 failed to load',err));