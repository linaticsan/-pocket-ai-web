...
(async()=>{
 ...
 await load('./v3.js?v=20260920-v57');
 await load('./v3-guard.js?v=20260920-v56');
 await load('./coding-v1.js?v=20260920-v56');
 await load('./files-v32.js?v=20260920-v57');
 await load('./library-v33.js?v=20260920-v57');
 await load('./library-online-v34.js?v=20260920-v56');
 await load('./webnovel-v42.js?v=20260920-v56');
 await load('./home-v43.js?v=20260920-v57');
 await load('./ui-v55.js?v=20260920-v56');
 await load('./repair-v56.js?v=20260920-v57');
 await load('./reference-ui-v57.js?v=20260920-v57');
})();
...
setTimeout(async()=>{
  ...
  if(legacy){
    try{
      lib.remove();
      const mod=await import('./library-v33.js?v=20260920-v57');
