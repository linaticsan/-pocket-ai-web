...
const v3style=document.createElement('link');v3style.rel='stylesheet';v3style.href='./v3.css?v=20260921-v73';document.head.appendChild(v3style);
const v3hotfix=document.createElement('link');v3hotfix.rel='stylesheet';v3hotfix.href='./v3-hotfix.css?v=20260921-v73';document.head.appendChild(v3hotfix);
...
(async()=>{
 ...
 await Promise.all([load('./api-hub.js?v=20260921-v73'),load('./v3.js?v=20260921-v71')]);
 await load('./v3-guard.js?v=20260920-v56');
 await load('./ui-v59.js?v=20260921-v71');
 await Promise.all([
   load('./coding-v1.js?v=20260921-v72'),
   load('./files-v32.js?v=20260921-v59'),
   load('./library-v33.js?v=20260921-v59')
 ]);
 await load('./library-online-v34.js?v=20260921-v73');
 await load('./webnovel-v42.js?v=20260921-v73');
