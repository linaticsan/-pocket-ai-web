...
import('./api-hub.js?v=20260919-1').then(()=>import('./v3.js?v=20260919-v37toolbar1')).then(()=>import('./v3-guard.js?v=20260918-safe1')).then(()=>import('./coding-v1.js?v=20260918-1')).then(()=>import('./files-v32.js?v=20260919-1')).then(()=>import('./library-v33.js?v=20260919-v38privacy1')).then(()=>import('./library-online-v34.js?v=20260919-v38free1')).catch(err=>console.error('Pocket AI module failed to load',err));
