...
assert(index.includes("const BUILD='step20-browser-regression'"),'STEP 20 build marker is missing');
...
assert(sw.includes("const CACHE=APP_CACHE_PREFIX+'v20'"),'STEP 20 app-shell cache must be v20');
