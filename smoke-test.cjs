...
assert(index.includes("const BUILD='step10-mobile-home'"),'STEP 10 build marker is missing');
...
assert(sw.includes("const CACHE=APP_CACHE_PREFIX+'v9'"),'STEP 10 app-shell cache must be v9');
