...
assert(index.includes("const BUILD='step14-legacy-cleanup'"),'STEP 14 build marker is missing');
...
assert(sw.includes("const CACHE=APP_CACHE_PREFIX+'v13'"),'STEP 14 app-shell cache must be v13');
